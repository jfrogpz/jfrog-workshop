...
If Copilot Chat is unavailable, participants can read this file (`.github/copilot-instructions-en.md`) directly and follow the steps — all task instructions, commands, and success criteria are fully listed here.

Participants not using Codespace should refer to [SETUP_EN.md](../SETUP_EN.md) for local environment setup.
