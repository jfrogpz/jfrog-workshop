...
学员选择模块后，**只跟随**该模块定义的任务指令。各模块的详细任务步骤在 `.github/instructions/<模块名>.instructions.md` 中——当学员在编辑器中打开该模块目录下的文件时，该文件会自动加载。

如果学员中途想切换模块，他们可以说"我要切换到 [模块名]"。确认切换：**"好的，切换到 [模块名]。我将按照 [模块名] 的任务指南继续引导你。"**
