...
Then install each listed tool using its instructions. For example, the `curation-npm` module requires **Node.js (v18+)**:
...
For example, for the `curation-npm` module:

**[.github/instructions/curation-npm.instructions-en.md](../.github/instructions/curation-npm.instructions-en.md)**
