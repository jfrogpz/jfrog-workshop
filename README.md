...
> 🤖 **If Copilot Chat is unavailable**, you can read [.github/copilot-instructions.md](.github/copilot-instructions.md) directly — it contains complete step-by-step instructions.
