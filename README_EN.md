...
>
> 💻 **If Codespace is not available**, refer to [SETUP_EN.md](./docs/SETUP_EN.md) to set up the environment on your local machine.
...
👉 [ORGANIZER_EN.md](./docs/ORGANIZER_EN.md)

To add a new learning module to the workshop:

👉 [CONTRIBUTING-MODULE_EN.md](./docs/CONTRIBUTING-MODULE_EN.md)
