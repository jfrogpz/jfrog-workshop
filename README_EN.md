...
>
> 💻 **If Codespace is not available**, refer to [SETUP_EN.md](./SETUP_EN.md) to set up the environment on your local machine.
...
> 🤖 **If Copilot Chat is unavailable**, you can read [.github/copilot-instructions-en.md](.github/copilot-instructions-en.md) directly — it contains complete step-by-step instructions for all tasks.
...
👉 [ORGANIZER_EN.md](./ORGANIZER_EN.md)
